...
export default function DownloadPage() {
  ...
  return (
    <div className="min-h-screen bg-[#E8EFF4] text-slate-800 font-sans flex flex-col overflow-x-hidden">
      ...
      <main className="flex-1 max-w-7xl w-full mx-auto px-6 pt-4 pb-12 md:pt-6 md:pb-16 flex flex-col items-center">
        ...
        <motion.div 
          ...
          className="max-w-3xl w-full flex flex-col items-center text-center mt-2"
        >
          ...
          <p className="text-xs md:text-sm text-slate-600 font-medium leading-relaxed mb-4 max-w-2xl">
          ...
          <div className="space-y-4 mb-3 text-left max-w-md mx-auto">
          ...
          <img 
            ...
            className="w-full max-w-lg h-auto object-contain hover:scale-[1.02] transition-transform duration-300 mb-10" 
          />

          {/* Dynamic Button CTA Box */}
          {mounted && (
            <div className="bg-white/60 backdrop-blur-lg border border-slate-200/50 rounded-3xl p-6 shadow-md max-w-lg w-full mx-auto">
